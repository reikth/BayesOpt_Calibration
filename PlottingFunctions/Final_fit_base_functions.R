...
fieldDataAll <-read.table(paste(GitDir,"LikelihoodComp/fieldData.txt", sep=""))
...
# =============================================================================
#
# OBECTIVES AND THEIR PLOT INPUTS COMMANDS:
# functions to get field data and model predictions and to store data for later plots for each objective
#
# =============================================================================
# =============================================================================
# =============================================================================
...
OBJ_AgePatternIncidenceAfterIntervention <- function(fieldDataAll, fieldDataID, modelResultID, densBias, runDir){
  ...
  return(list(LF = lossVectorObj_1, Data = list(FieldData = incidenceData, ModelResults = modelResults)))
}
...
OBJ_AgePatternPrevalenceAndDensity<-function(fieldDataAll, fieldDataID, modelResultID, densBias, runDir){
  ...
  return(list(LF = combinedObj, Data =list(FieldData=asexualData, ModelResults = modelResults)))
}
...
OBJ_AgePatternMOI <- function(fieldDataAll, fieldDataID, modelResultID, runDir){	
  ...
  return(list(LF = lossVectorObj_4, Data = list(FieldData = moiData,ModelResults = modelResults)))
...
OBJ_AgePatternIncidenceClinicalMalaria_Senegal <- function(fieldDataAll, fieldDataID, modelResultID, runDir){
  ...
  return(list(LF = lossVectorObj_5a, Data = list(FieldData = acuteSenegalData, ModelResults = modelResults)))
...
OBJ_AgePatternIncidenceClinicalMalaria_Idete <- function(fieldDataAll, fieldDataID, modelResultID, runDir){
  ...
  return(list(LF = lossVectorObj_5b, Data = list(FieldData = acuteIdeteData, ModelResults = modelResults)))
}
...
OBJ_AgePatternThresholdClinicalAttack <- function(fieldDataAll, fieldDataID, modelResultID, densBias, runDir){
  ...
  return(list(LF = lossVectorObj_6, Data = list(FieldData = acutePyGenThresData, ModelResults = modelResults)))
}
...
OBJ_SevereEpisodesVsPrevalence <- function(fieldDataAll, fieldDataID, modelResultID, runDir){
  ...
  if(drop_point){severeData[[2]]=severeData[[2]][c(1:3,5:length(severeData[[2]]))]; severeData[[3]]=severeData[[3]][c(1:3,5:length(severeData[[3]]))]}
  ...
  return(list(LF = lossVectorObj_7, Data = list(FieldData = severeData, ModelResults = modelResults)))
...
OBJ_AgePatternOfSevere<- function(fieldDataAll, fieldDataID, modelResultID, runDir){
  ...
  return(list(LF = lossVectorObj_8, Data = list(FieldData = severeData, ModelResults =modelResults, SevereField = severeField, PlotData = plotData)))
  }
...
OBJ_DirectMalariaMortality <- function(fieldDataAll, fieldDataID, modelResultID, runDir){
  ...
  return(list(LF = lossVectorObj_9, Data = list(FieldData = dirMortField, ModelResults = modelResults)))
...
OBJ_indirectMortality <- function(fieldDataAll, fieldDataID, modelResultID, runDir){
  ...
  return(list(LF= lossVectorObj_10, Data = list(FieldData = indirMortField, ModelResults = modelResults)))
}
